        ...
        renderers["string"] = function (container, id, parentObject, propertyProvider, value) {
            ...
            if (s.type === "any") {
                ...
                if (s.type === "integer" || s.type === "number") {
                    ...
                    input.className += ' datetime-local';
                ...
                if (value !== null && typeof value !== "undefined") {
                    ...
                    if (input.type == "datetime-local") {
                        //something wrong with this – hour incrementing by 1. To fix later
                        d = new Date(value);
                        //console.log(d.toISOString())
                        dayval = ("0" + d.getDate()).slice(-2);
                        monthval = ("0" + (d.getMonth() + 1)).slice(-2);
                        yearval = d.getFullYear();
                        dateval = yearval+'-'+monthval+'-'+dayval
                        //timeval = d.toLocaleTimeString([], {hour: '2-digit', minute: '2-digit', hour12: false });
                        hourval = ("0" + d.getUTCHours()).slice(-2);
                        minval = ("0" + d.getMinutes()).slice(-2);
                        timeval = hourval+":"+minval
                        input.value = dateval + 'T' + timeval;
                        //console.log(dateval + 'T' + timeval + 'Z')
                    }
                    if (s.readOnly)
                        input.disabled = true;
...
//        }
        ...
        renderers["object"] = function (container, id, parentObject, propertyProvider, value) {
            ...
            function addAdditionalProperty(current, table, id, name, value, button) {
                ...
                var innerTab = document.createElement("fieldset");
                var innerTr = document.createElement("div");
                var innerTd1 = document.createElement("div");
                var innerTd2 = document.createElement("div");
                ...
                if (button !== undefined) {
                    var secondTr = document.createElement("div");
                    var secondTd = document.createElement("div");
            ...
            if (s.hasOwnProperty("properties")) {
                ...
                for (var prop in s.properties) {
                    ...
                    td2.className = "prop-value";
                    appendChild(tbody, tr, s);
                    appendChild(tr, td0, s);
                    appendChild(td0, td1, s);
                    appendChild(td0, td2, s);
        ...
        renderers["array"] = function (container, id, parentObject, propertyProvider, value) {
            ...
            div.className = table.className = "array";
            appendChild(div, table, s);
            appendChild(container, div, s);
            var addButton = document.createElement("button");
            if (s.readOnly)
            ...
            function removeEmptiesAndNulls(object) {
                if (object instanceof Array) {
                    ...
                    for (var prop in object) {
                        ...
                        // Hard coding this since I can't figure out any other way.
                        // Fortunately the keys affected are known (i.e. value and minValue – for now)
                        /*
                        ...
                        // Okay, I finally found a generic way!
